...
if __name__ == "__main__":
    print(    quat_unit(
        torch.tensor([1., 1., 0., 0]).reshape(1,1,1,-1)
        ))
    print(    quat_mul(
        torch.tensor([1., 0., 0., 0]).reshape(1,1,1,-1), 
        torch.tensor([1., 0., 0., 0]).reshape(1,1,1,-1)
        ))
    print(    quat_abs(
        torch.tensor([-1., 0., 0., 0]).reshape(1,1,1,-1)
    ...
    print(    quat_exp(
        torch.tensor([3.141592, 0., 0.]).reshape(1,1,1,1,1,-1)
        ))
    print(    quat_log(
        torch.tensor([0., 1, 0., 0]).reshape(1,1,1,-1)
        ))
    print(quat_differentiate_angular_velocity(
        torch.tensor([0., 1, 0., 0]).reshape(1,1,1,-1),
        torch.tensor([1., 0., 0., 0]).reshape(1,1,1,-1),
        torch.tensor([1])
        ))
    print(
        quat_integrate_angular_velocity(
            torch.tensor([3.141592, 0, 0.]).reshape(1,1,1,-1),
            torch.tensor([1., 0., 0., 0]).reshape(1,1,1,-1),
            torch.tensor([1])
            ))
    print(q_2_m(
